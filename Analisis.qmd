...
ggarrange(reglin5, reglin6, reglin7, reglin8)+   labs( caption = "Posteriors de los parametros para cada variable morfológica") + theme(plot.caption = element_text(hjust = .5, vjust = 3, color = "#555555"))
```
...
ggarrange(plot6, plot5) + labs( caption = "Distribución de las variables demograficas vs diagnóstico") + theme(plot.caption = element_text(hjust = .5, vjust = 2, color = "#555555"))
```
